...
- A pasted URL in a note renders as a clickable link; wrap one as `[Text shown](url)` to replace the URL with your own label (great for songs, articles, anything from the web). Notes stay plain text.
